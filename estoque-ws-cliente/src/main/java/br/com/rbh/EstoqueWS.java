...
public interface EstoqueWS {
    ...
    @RequestWrapper(localName = "TodosOsItens", targetNamespace = "http://ws.estoque.caelum.com.br/", className = "br.com.rbh.TodosOsItens")
    @ResponseWrapper(localName = "TodosOsItensResponse", targetNamespace = "http://ws.estoque.caelum.com.br/", className = "br.com.rbh.TodosOsItensResponse")
     ...
     * @param parameters
     * @return
     *     returns br.com.rbh.CadastrarItemResponse
